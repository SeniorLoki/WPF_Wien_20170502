...
namespace HalloMVVM.ViewModels
{
    public class RelayCommand : ICommand
    {
        ...
        {
            _executeHandler = execute ?? throw new ArgumentNullException(nameof(execute), "Execute must not bei null.");
        }
        ...
        {
            return _canExecuteHandler?.Invoke() ?? true;
        }
    ...
    public class RelayCommand<T> : ICommand
    {
        ...
        public bool CanExecute(object parameter)
        {
            return _canExecuteHandler?.Invoke((T)parameter) ?? true;
        }
